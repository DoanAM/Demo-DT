...
#ifndef MW_MWTIJCOORDSYSTEM2D_HPP_
#define MW_MWTIJCOORDSYSTEM2D_HPP_
...
namespace geoDef
{
	...
	*/
	template <class T>
	class MW_5AXUTIL_API mwTijCoordSystem2d
	...
	private:
		typedef mwTijCoordSystem2d<ValueType>	MySelf;
	public:
...
//#############################################################################
		...
		/*
				...
				\param j the j axis of this CS, default is (0,1)
		*/
		mwTijCoordSystem2d(const PositionVector &origin=PositionVector (0,0),
						   const PositionVector &i=PositionVector (1,0),
						   const PositionVector &j=PositionVector (0,1));
//#############################################################################
		//! clones the CS
		/*
...
//#############################################################################
	typedef mwTijCoordSystem2d< float > CSijOrigin2df;
	typedef mwTijCoordSystem2d< double > CSijOrigin2dd;
}
#endif	//	MW_MWTIJCOORDSYSTEM2D_HPP_
