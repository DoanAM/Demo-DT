...
#ifndef MW_MW2DWEIGHTMATRIX_HPP_
#define MW_MW2DWEIGHTMATRIX_HPP_
...
namespace cadcam
{
/// This class represents a 2d matrix of Weights
#pragma CACHING_INTERNAL_BEGIN
class MW_5AXUTIL_API mw2dWeightMatrix
{
public:
	...
	mw2dWeightMatrix(const size_t rows, const size_t columns);
...
#endif  //	MW_MW2DWEIGHTMATRIX_HPP_
