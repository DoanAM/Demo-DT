...
/// mwPostedMoveCloner class

//#############################################################################

#ifndef MW_MWPOSTEDMOVECLONER_HPP_
#define MW_MWPOSTEDMOVECLONER_HPP_
...
namespace post
{
	...
	//#############################################################################
	class MW_5AXUTIL_API mwPostedMoveCloner : public mwPostedVisitor
	{
	public:
		mwPostedMoveCloner(mwPostedMovePtr& postedMovePtr);
		//#############################################################################
	...
	private:
		//#############################################################################
		mwPostedMovePtr& m_postedMovePtr;
		//#############################################################################
		mwPostedMoveCloner& operator = (const mwPostedMoveCloner&) { return *this; }// avoid warning c4512
		//#############################################################################
	};	
};
//#############################################################################
#endif	//	MW_MWPOSTEDMOVECLONER_HPP_
