...
#ifndef MW_MWTIJKCOORDSYSTEM3D_HPP_
#define MW_MWTIJKCOORDSYSTEM3D_HPP_
...
namespace geoDef
{
	...
	*/
	template <class T>
	class MW_5AXUTIL_API mwTijkCoordSystem3d
	...
	private:
		typedef mwTijkCoordSystem3d<ValueType>	MySelf;
	public:
...
//#############################################################################
		...
		/*
				...
				\param k the k axis of this CS, default is (0,1,0)
		*/
		mwTijkCoordSystem3d(const PositionVector &origin=PositionVector (0,0,0),
						   const PositionVector &i=PositionVector (1,0,0),
						   const PositionVector &j=PositionVector (0,1,0),
						   const PositionVector &k=PositionVector (0,0,1));
//#############################################################################
		//! clones the CS
		/*
...
//#############################################################################
		//! Sets k axis of CS
		/*
				\param k the new k axis
		*/
		void Setk(const PositionVector &k);
//#############################################################################
		//! Gets k axis of CS
		/*
				\returns k axis of CS
		*/
		inline const PositionVector& Getk() const
		{
			return mk;
		}
//#############################################################################
...
//#############################################################################
	typedef mwTijkCoordSystem3d< float > CSijkOrigin3df;
	typedef mwTijkCoordSystem3d< double > CSijkOrigin3dd;
}
#endif	//	MW_MWTIJKCOORDSYSTEM3D_HPP_
